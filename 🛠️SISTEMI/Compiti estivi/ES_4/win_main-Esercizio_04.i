...
# 4 "Esercizio_04.c" 2
# 1 "/usr/x86_64-w64-mingw32/include/ctype.h" 1 3
# 9 "/usr/x86_64-w64-mingw32/include/ctype.h" 3
# 1 "/usr/x86_64-w64-mingw32/include/corecrt_wctype.h" 1 3
# 31 "/usr/x86_64-w64-mingw32/include/corecrt_wctype.h" 3
  __attribute__ ((__dllimport__)) const unsigned short* __pctype_func(void);
# 45 "/usr/x86_64-w64-mingw32/include/corecrt_wctype.h" 3
...
# 72 "/usr/x86_64-w64-mingw32/include/corecrt_wctype.h" 3
...
# 10 "/usr/x86_64-w64-mingw32/include/ctype.h" 2 3
# 21 "/usr/x86_64-w64-mingw32/include/ctype.h" 3
...
# 18 "Esercizio_04.c"
        ...
        int scelta = atoi(line);

        if (scelta == 0) {
            return 0;
        }
        else if (scelta == 1) {
            FILE *f = fopen("questionario.txt", "a");
            if (!f) {
                printf("errore file\n");
                continue;
            }

            char ques[1024], a[1024], b[1024], c[1024], d[1024];

            printf("Domanda > ");
            fgets(ques, sizeof(ques), 
# 34 "Esercizio_04.c" 3
                                     (__acrt_iob_func(0))
# 34 "Esercizio_04.c"
                                          );
