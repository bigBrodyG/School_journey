...
int isValidMac(const char *s) {
    ...
    unsigned char b[6];
    int counter = 0;
    int ok = sscanf(s, "%2hhx:%2hhx:%2hhx:%2hhx:%2hhx:%2hhx%n", &b[0], &b[1], &b[2], &b[3], &b[4], &b[5], &counter);
...
int main() {
    char line[100];
    FILE *storage = fopen("arp_table.txt", "a+");
